...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        n1 = Post.objects.filter(author=self.id).aggregate(rating=Sum('rating'))['rating'] * 3
